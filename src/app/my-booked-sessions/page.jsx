                ...
                <tr key={booking._id}>
                  ...
                  <td className="border p-3 flex gap-2">
                    <button
                      ...
                      className="bg-red-600 text-white px-3 py-1 rounded disabled:bg-gray-400 cursor-pointer transition hover:scale-100 font-bold"
                    >
                      Cancel
                    </button>
                    ...
                    <button
                      ...
                      className="bg-gray-700 text-white px-3 py-1 rounded cursor-pointer transition hover:scale-100 font-bold"
                    >
                      Delete
                    </button>
                  </td>
