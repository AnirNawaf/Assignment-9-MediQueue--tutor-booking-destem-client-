...
const Tutors = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-5 py-10">
      <h2 className="text-3xl font-bold text-center mb-6">Available Tutors55555</h2>

      <div className="mb-6 flex flex-wrap justify-center gap-3">
        {subjects.map((subject) => (
          <button key={subject} onClick={() => setSubjectFilter(subject)}  className={
            `
            px-4 py-2 rounded ${subjectFilter === subject
        ...
        <button onClick={() => setSubjectFilter("d")}  className={
          `
          px-4 py-2 rounded ${subjectFilter === "List" // ekhane "d" check kora hocche
              ? "bg-blue-600 text-white"
              : "bg-gray-200 text-gray-700"
            }
