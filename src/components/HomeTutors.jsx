...
const HomeTutors = ({ tutors }) => {
  return (
    <section className="max-w-7xl mx-auto px-5 py-12">
      ...
      <div className="mt-12 grid grid-cols-2 md:grid-cols-3 gap-6 text-center bg-gradient-to-r from-purple-800 to-purple-900 text-white rounded-xl p-8 shadow">
